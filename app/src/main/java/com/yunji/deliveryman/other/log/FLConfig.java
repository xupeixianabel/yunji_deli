...
import static com.yunji.deliveryman.other.log.FLConst.RetentionPolicy.FILE_COUNT;
import static com.yunji.deliveryman.other.log.FLConst.RetentionPolicy.TOTAL_SIZE;
...
public class FLConfig {
    ...
    public static class DefaultFormatter implements FileFormatter {
        ...
        private final ThreadLocal<SimpleDateFormat> mFileNameFmt = new ThreadLocal<SimpleDateFormat>() {
            @Override
            protected SimpleDateFormat initialValue() {
                return new SimpleDateFormat("yyyy-MM-dd-HH", Locale.ENGLISH);
            }
        };
