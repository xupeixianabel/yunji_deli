...
import com.yunji.deliveryman.common.Configs;
...
public class FileLoggerService extends IntentService {
	...
	private static final String tag = "IPForwardFileLoggerService";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if(!Configs.isEmulaotr) //真机才保存LOG
	    {
	        //Log.w(tag, "zyb === [FileLoggerService] onHandleIntent");
    ...
    public void onDestroy() {
        super.onDestroy();
        //Log.w(tag, "zyb === [FileLoggerService] onDestroy");
        closeWriter();
        startHouseKeeping();
    }
