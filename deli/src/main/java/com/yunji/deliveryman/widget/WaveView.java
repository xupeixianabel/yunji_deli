package com.yunji.deliveryman.widget;
...
public class WaveView extends View {
     ...
     * 波浪圆圈颜色
     */
    private int mColor = getResources().getColor(R.color.light_blue);
    /**
     * 第一个圆圈的半径(也就是圆形图片的半径)
     */
    private int mImageRadius=150;
    /**
     * 波浪圆之间间距
     */
     ...
     * 最大宽度
     */
    private Integer mMaxRadius = 170;
    /**
     * 是否正在扩散中
     */
    ...
    public void onDraw(Canvas canvas) {
        ...
        /*    PathEffect effects = new DashPathEffect(new float[]{8,10,8,10},8);
            mPaint.setPathEffect(effects);*/
//            mPaint.setPathEffect(new DashPathEffect(new float[]{24, 24,24}, 1));
            ...
            }else if( mImageRadius+radius > mMaxRadius){
        ...
        if (mRadius.size()>1 && mRadius.get(mRadius.size() - 1) == 170) {
           addWave();
        }
